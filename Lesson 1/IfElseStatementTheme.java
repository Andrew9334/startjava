public class IfElseStatementTheme {
    public static void main(String[] args) {
        ...
        if ((number3 / 100) == (number4 / 100)) {
            System.out.println((number3 / 100) + " = " + (number4 / 100));
            if ((number3 / 10 % 10) == (number4 / 10 % 10)) {
                System.out.println((number3 / 10 % 10) + " = " + (number4 / 10 % 10));
            }
            if ((number3 % 100 % 10) == (number4 % 100 % 10)) {
                System.out.println((number3 % 100 % 10) + " = " + (number3 % 100 % 10));
            }
        } else {
